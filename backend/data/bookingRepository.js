...
class BookingRepository {
  static async create({ userId, teacherId, datetime, message, sessionModality = null, bookingSubjects = null }) {
    const subjectsStr =
      bookingSubjects && Array.isArray(bookingSubjects)
        ? JSON.stringify(bookingSubjects)
        : bookingSubjects
          ? String(bookingSubjects)
          : null;
    const sql = `INSERT INTO bookings (userId, teacherId, datetime, message, sessionModality, bookingSubjects) VALUES (?, ?, ?, ?, ?, ?)`;
  ...
  static async getByUserId(userId) {
    const sql = `
      SELECT b.*,
        ...
        t.locationStreet AS teacherLocationStreet,
        t.locationNumber AS teacherLocationNumber,
        t.locationApartment AS teacherLocationApartment,
        t.description AS teacherDescription,
        t.curriculum AS teacherCurriculum,
        ...
        b.bookingSubjects AS bookingSubjects
      FROM bookings b
